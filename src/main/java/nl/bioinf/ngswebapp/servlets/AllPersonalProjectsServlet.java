...
//        }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        projectsMap.put("Project 1", new String[]{"testplaceholder0.fastq.gz", "testplaceholder1.fastq.gz"});
        projectsMap.put("Project 2", new String[]{"testplaceholder0.fastq.gz", "testplaceholder1.fastq.gz", "testplaceholder2.fastq.gz"});
